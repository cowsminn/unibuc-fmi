...
// ROL - default input/output filenames (use distinct macro names to avoid collisions)
#define PHOTON_DEFAULT_IN_FILE  "input_test.txt"
#define PHOTON_DEFAULT_OUT_FILE "output_test.txt"
